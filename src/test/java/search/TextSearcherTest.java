...
// String[] expected = { "enlarged in 1844 into a", "sketch of 1844--honoured
// me" };
// File file = new File("files/long_excerpt.txt");
// TextSearcher searcher = new TextSearcher(file);
...
// String[] expected = { "and that the existing forms of life", "generation of
// pre existing forms." };
// File file = new File("files/short_excerpt.txt");
// TextSearcher searcher = new TextSearcher(file);
...
// // instance:
// expected = new String[] { "on the Origin of Species. Until recently the
// great",
// "of naturalists believed that species were immutable productions, and",
// "hand, have believed that species undergo modification, and that" };
// results = searcher.search("species", 4);
...
// expected = new String[] { "and that the existing forms of life", "generation
